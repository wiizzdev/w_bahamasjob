local mainMenu = RageUI.CreateMenu("", "Fabrication de Cocktails")
                ...
                RageUI.IsVisible(mainMenu, function()
                    if not craftencours then
                        ...
                        if chargement >= 1.0 then
                            ...
                            TriggerServerEvent('bahamas:preparer', name)
                            Wait(2000)
                            ClearPedTasksImmediately(GetPlayerPed(-1))
...
Citizen.CreateThread(function()
    while true do
    	...
    	for k,v in pairs(Config.Cocktails.Pos) do
        	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bahamas' and ESX.PlayerData.job.grade_name == 'barman' then
